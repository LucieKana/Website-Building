...
//Get the data from API and content to my web page
function Searchcoffeetitle(){
  fetch("https://api.sampleapis.com/coffee/hot")
  .then((response) => response.json())
  .then((jsonData) =>{
     const result = jsonData.map(element => element.title);
    console.log(result);
  });
}
...
window.onload = () =>{
  ...
  searchFieldElement.onkeyup= (event) =>{
      ...
      searchTimeoutToken = setTimeout(() => {
          Searchcoffeetitle(searchFieldElement.value);
      }, 250);
  } 
}
// show Nav
